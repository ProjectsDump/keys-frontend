...
export const handleGenerate = (setPassword: Function, passwordLength: number, passParams: StrengthInterface) => {
...
export const checkPasswordStrength = (passwordLength: number, setPassStrength: Function, setRemoveDisabled: Function, setAddDisabled: Function) => {
...
export const handleBtnClick = (type: string, setPasswordLength: Function, passwordLength: number, setPassStrength: Function, setRemoveDisabled: Function, setAddDisabled: Function, setPassword: Function, passParams: StrengthInterface) => {
    ...
    checkPasswordStrength(passwordLength, setPassStrength, setRemoveDisabled, setAddDisabled);
    handleGenerate(setPassword, passwordLength, passParams);
};

// handle slider
export const handleSlider = (e: any, setPasswordLength: Function, passwordLength: number, setPassStrength: Function, setRemoveDisabled: Function, setAddDisabled: Function, setPassword: Function, passParams: StrengthInterface) => {
    e.preventDefault();
