			...
			<div className='what-long-section'>
				...
				<div className='what-long-body'>
					<div className='what-long-item first'>
						...
						<h3>Unique</h3>
						<p>
							A secure password should be unique to each accound
					...
					<div className='what-long-item second'>
						...
						<h3>Long</h3>
						<p>
							A secure password should have at least 10
							characters. The longer the password the more secure
							it is.
						</p>
					</div>
					<div className='what-long-item second'>
						...
						<h3>Complex</h3>
						<p>
							A secure password should be a complex combination of
							different characters, numbers and symbols to form a
							random string that doesn&apos;t resemble a name or a
							normal word.
						</p>
					</div>
				</div>
